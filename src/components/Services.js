...
function Services() {
  const services = [
    ...
    { title: 'Ocean Freight Services', description: 'Noor Al Amwaj handles movement of cargo from/to any global origin/destination, be it LCL or FCL. With its own Container Freight Station (CFS) and Supply Chain facilities, As a leading NVOCC, we have been maintaining an excellent relationship with leading carriers, ensuring competitive rates and services' },
